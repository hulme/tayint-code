...
(* ::Input:: *)
(*SecDecDir="/home/ttp/dhulme/SecDec-3.0.9/loop/tridom1correct/I59/I59_sEUC/"*)


(* ::Input:: *)
(*ItSecDir="/home/ttp/dhulme/SecDec-3.0.9/loop/tridom1correct/I59/I59_sEUC/numerics/together/epstothe0/";*)
...
(* ::Input:: *)
(*ResKine=Table[{i,-2*29929,0.5*29929,29929},{i,4*29929,16*29929,12/200*29929}];*)
...
(* ::Input:: *)
(*Table[If[Length[GoodListSecKine[[i]]]<Round[Length[KineList]/2],Table[pKMRPSE[i,l]=(<<((ToString[name1]<>"partialRPSE["<>ToString[i]<>","<>ToString[l]<>"]"<>".txt"))),{i,SecStart,SecFin}]],{l,1,Length[varlist]}];*)
...
(* ::Input:: *)
(*Table[If[Length[GoodListSecKine[[i]]]<Round[Length[KineList]/2],pCornKMLSE[i,l]=(List[pKMRPSE[i,l][[4]]/pKMRPSE[i,l][[3]]])],{i,SecStart,SecFin},{l,1,Length[varlist]}]*)
...
(* ::Input:: *)
(*Table[If[Length[GoodListSecKine[[i]]]<Round[Length[KineList]/2],pStartKMLSE[i,l]=(List[pKMRPSE[i,l][[2]]/pKMRPSE[i,l][[1]]])],{i,SecStart,SecFin},{l,1,Length[varlist]}]*)
...
(* ::Input:: *)
(*Table[Table[If[Length[GoodListSecKine[[i]]]<Round[Length[KineList]/2],(pPermKMLSE[i,l]=Permutations[pKMRPSE[i,l]])],{i,SecStart,SecFin}],{l,1,Length[varlist]}];*)
...
(* ::Input:: *)
(*Table[Table[If[Length[GoodListSecKine[[i]]]<Round[Length[KineList]/2],pPermKMDLSE[i,l]=Table[(List[pPermKMLSE[i,l][[j]][[2]]/pPermKMLSE[i,l][[j]][[1]],pPermKMLSE[i,l][[j]][[3]]/pPermKMLSE[i,l][[j]][[2]],pPermKMLSE[i,l][[j]][[4]]/pPermKMLSE[i,l][[j]][[3]]]),{j,1,Length[pPermKMLSE[i,l]]}]],{i,SecStart,SecFin}],{l,1,Length[varlist]}];*)
...
(* ::Input:: *)
(*Table[Table[If[Length[GoodListSecKine[[i]]]<Round[Length[KineList]/2],pMePermKMDLSE[i,l]=Mean[Table[pPermKMDLSE[i,l][[j]],{j,1,Length[pPermKMLSE[i,l]]}]]],{i,SecStart,SecFin}],{l,1,Length[varlist]}]*)
...
(* ::Input:: *)
(*Table[TayIntRes[i]=COMPKineTABTABFlexVarIndFast3ThWheelB[i,i,(ToString[name]<>"OTEPS"<>ToString[epsord]),varlist,varlist,0,4,CCNIELcalc[[CCFinal[i]]],RatKMSE[[i]],kinenames,ResKine[[#]],#],{i,SecStart,SecFin}]&/@Range[1,Length[ResKine]]*)


(* ::Input:: *)
(*Table[If[Length[GoodListSecKine[[i]]]<Round[Length[KineList]/2],TayIntRes[i]=COMPKineTABTABFlexVarIndFast3ThWheelB[i,i,(ToString[name]<>"OTEPS"<>ToString[epsord]),SubVarFinalTab[[PartSubFinal[#]]],SubVarFinalTab[[PartSubFinal[#]]],0,4,CCNIELpartialcalc[[PartSubFinal[#]]][[PartContFinal[#]]],RatKMSE[[i]],kinenames,ResKine[[#]],#]],{i,SecStart,SecFin}]&/@Range[1,Length[ResKine]]*)


(* ::Input:: *)
(*(TayIntResDiff[#]=Table[Abs[TayIntRes[#][[i+1]]/TayIntRes[#][[i]]],{i,1,Length[TayIntRes[#]]-1}])&/@Range[SecStart,SecFin]*)


(* ::Input:: *)
(*(TayIntResDudPos[#]=Flatten[Table[If[TayIntResDiff[#][[i]]>1.1||TayIntResDiff[#][[i]]<0.9,Position[TayIntResDiff[#],TayIntResDiff[#][[i]]]+1],{i,1,Length[TayIntRes[#]]-1}]/.{Null->Nothing}])&/@Range[SecStart,SecFin]*)


(* ::Input:: *)
(*(MinTayIntResDudPos[#]=Min[TayIntResDudPos[#]])&/@Range[SecStart,SecFin]*)


(* ::Input:: *)
(*(MaxTayIntResDudPos[#]=Max[TayIntResDudPos[#]])&/@Range[SecStart,SecFin]*)
...
(* ::Input:: *)
(*If[Length[TayIntResDudPos]>0,COMPDiscTaySliceOutput[1,#,(ToString[name]<>"OTEPS"<>ToString[epsord]),varlist,varlist,0,4,CCNIELcalc[[CCFinal[#]]],RatDud]]&/@Range[SecStart,SecFin]*)


(* ::Input:: *)
(*If[Length[GoodListSecKine[[#]]]<Round[Length[KineList]/2],If[Length[TayIntResDudPos]>0,COMPDiscTaySliceOutput[1,#,(ToString[name]<>"OTEPS"<>ToString[epsord]),SubVarFinalTab[[PartSubFinal[#]]],SubVarFinalTab[[PartSubFinal[#]]],0,4,CCNIELpartialcalc[[PartSubFinal[#]]][[PartContFinal[#]]],RatDud]]]&/@Range[SecStart,SecFin]*)


(* ::Input:: *)
(*If[Length[TayIntResDudPos]>0,Table[TayIntRes[i]=COMPKineTABTABFlexVarIndFast3ThWheelB[i,i,(ToString[name]<>"OTEPS"<>ToString[epsord]),varlist,varlist,0,4,CCNIELcalc[[CCFinal[i]]],RatDud,kinenames,ResKine[[#]],#]&/@Range[MinTayIntResDudPos[i]-3,MaxTayIntResDudPos[i]+3],{i,SecStart,SecFin}]]*)


(* ::Input:: *)
(*Table[If[Length[GoodListSecKine[[i]]]<Round[Length[KineList]/2],If[Length[TayIntResDudPos]>0,TayIntRes[i]=COMPKineTABTABFlexVarIndFast3ThWheelB[i,i,(ToString[name]<>"OTEPS"<>ToString[epsord]),SubVarFinalTab[[PartSubFinal[#]]],SubVarFinalTab[[PartSubFinal[#]]],0,4,CCNIELpartialcalc[[PartSubFinal[#]]][[PartContFinal[#]]],RatDud,kinenames,ResKine[[#]],#]]]&/@Range[MinTayIntResDudPos[i]-3,MaxTayIntResDudPos[i]+3],{i,SecStart,SecFin}]*)
